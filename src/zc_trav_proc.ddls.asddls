...
define root view entity ZC_TRAV_PROC
  ...
  as projection on ZI_TRAV_ROOT
{
  key TravelId,
      ...
      /* Associations */
      _agency,
      _booking : redirected to composition child ZC_BOOKING_PROC,
      _attachment : redirected to composition child ZC_TRAV_ATTACH_PROC,
      _currency,
      _customer,
      ...
      @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_ARM_AT_TRAV_VE'
      @EndUserText.label: 'CO2 Tax'
      virtual co2tax: abap.int4,
      
      @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_ARM_AT_TRAV_VE'
      @EndUserText.label: 'Week Day'
      virtual flightday: abap.char( 9 )
